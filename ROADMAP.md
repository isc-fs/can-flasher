...
| 4 | Remaining subcommands | ✅ done `feat/10-discover-subcommand` · ✅ done `feat/11-diagnose-subcommand` · ✅ done `feat/12-verify-subcommand` · ✅ done `feat/13-config-subcommand` · 🔜 planned `feat/14-replay-subcommand` | `v0.4.0-subcommands` |
